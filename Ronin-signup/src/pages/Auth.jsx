  ...
  return (
    <main className="auth-page">
      <section className="brand-panel" aria-label="About Ronin">
        ...
        <div className="brand-footer"><span className="status-dot" aria-hidden="true" /> Local AI Engine: Ready (Ollama / Qwen 2.5 Coder)</div>
      </section>
      <section className="form-panel">
        <div className="form-wrap">
          <div className="mobile-brand"><div className="brand-mark"><LogoMark size={26} /><span>RONIN</span></div></div>
          <div className="form-heading"><p className="eyebrow">{mode === 'login' ? 'Welcome back' : 'Start your journey'}</p><h2>{mode === 'login' ? 'Sign in to Ronin' : 'Create your account'}</h2><p>{mode === 'login' ? 'Enter your details to continue to your workspace.' : 'Create your local Ronin credentials to access the security testing console.'}</p></div>
